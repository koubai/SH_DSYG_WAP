					...
					<div class="m-index-mod-bd">
						...
						<div class="award-wrapper">
							<table style="width: 100%;" border="0" cellpadding="0" cellspacing="10">
								<tbody>
									<tr>
										<td width="33%"><a class="index_btn12" href="./case_p01.shtml">
											<div class="product">
												<p>電子線</p>
												<p class="arial">Electronic Wire</p>
											</div>		</a>					
										</td>
										<td width="33%"><a class="index_btn12" href="./case_p02.shtml">
											<div class="product">
												<p>熱収束套管</p>
												<p class="arial">Heat-Shrink-Tube</p>
											</div>	</a>						
										</td>
										<td width="33%"><a class="index_btn12" href="./case_p03.shtml">
											<div class="product">
												<p>柔軟扁平電纜</p>
									...
									<tr>
										<td><a class="index_btn12" href="./case_p07.shtml">
											<div class="product">
												<p>标识和标签</p>
												<p class="arial">SumiTag SumiLabel</p>
											</div>	</a>						
										</td>
										<td><a class="index_btn12" href="./case_p04.shtml">
											<div class="product">
												<p>漆包線</p>
												<p class="arial">Magnesium Alloy</p>
											</div>	</a>						
										</td>
										<td><a class="index_btn12" href="./case_p05.shtml">
											<div class="product">
												<p>線束加工</p>
									...
									<tr>
										<td><a class="index_btn12" href="./case_p06.shtml">
											<div class="product">
												<p>柔軟印刷电路板</p>
												<p class="arial">Flexible Printed Circuit Bd</p>
											</div>		</a>					
										</td>
										<td><a class="index_btn12" href="./case_p08.shtml">
												<div class="product">
													<p>交联含氟树脂</p>
